...
[[https://github.com/sheerun/vim-polyglot][Vim-polyglot]] is a curated and frequently updated list [[https://github.com/sheerun/vim-polyglot#language-packs][list of more than 600 language packs]][fn:polyglot-add] to auto-load syntax highlighting and indentation rules.
Although the packs are downloaded on install, they're loaded on demand, so using vim-polyglot does not affect Vim's startup time.

[fn:polyglot-add] Vim-polyglot should have all languages you need.
